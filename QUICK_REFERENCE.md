...
| PATCH | `/api/products/{id}/stock-status?status=X` | Update stock |
| PATCH | `/api/products/{id}/price?price=X` | Update price |
...
curl -X POST http://localhost:8080/api/products \
  ...
  -d '{"name":"Olive Oil","category":"OIL","price":750,"unit":"LITRE","stockStatus":"IN_STOCK"}'
